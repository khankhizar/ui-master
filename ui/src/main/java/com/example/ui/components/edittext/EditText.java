 ...
 */
package com.example.ui.components.edittext;
...
import com.example.ui.components.textview.FontFactory;
import com.example.ui.intern.CustomPasswordTransformationMethod;
import com.example.ui.intern.UIContants;
...
import co.example.android.ui.links.Hyperlink;
import co.example.android.ui.links.InternalURLSpan;
import co.example.android.ui.links.RegexPatternsConstants;
import co.example.android.ui.links.TextLinkClickListener;
import co.example.android.ui.links.UrlCompleter;
...
public class EditText extends android.widget.EditText implements OnClickListener {
	...
	private void setCustomFont(Context ctx, AttributeSet attrs) {
		String typefaceName = attrs.getAttributeValue(
				UIContants.SCHEMA_URL, EDITTEXT_ATTRIBUTE_FONT_NAME);
...
//					| Paint.LINEAR_TEXT_FLAG);
	...
	private void setDisableCopyAndPaste(Context ctx, AttributeSet attrs) {
		boolean disableCopyAndPaste = attrs.getAttributeBooleanValue(
				UIContants.SCHEMA_URL, EDITTEXT_ATTRIBUTE_COPY_AND_PASTE,
				true);
